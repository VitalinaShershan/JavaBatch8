...
public class Task1 {
    ...
    Task1(){
        System.out.println("i will be called when no arguments are passed to the constractor");
    }
    ...
    Task1(int ageValue, String nameValue, char gradeValue){
        ...
        name=nameValue;
        grade=gradeValue;
        System.out.println("i will be called when 3 arguments are passed to the constractor");
    }

    Task1(int ageValue, String nameValue){
        age=ageValue;
        name=nameValue;
        System.out.println("i will be called when 2 arguments are passed to the constractor");
    }

    Task1(int ageValue ){
        age=ageValue;

        System.out.println("i will be called when 1 arguments are passed to the constractor");
    }
